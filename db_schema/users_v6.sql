-- Script SQL (PostgreSQL) para Tabela de Usuários v6
...
CREATE INDEX idx_users_company_tenant_v6 ON users(company_tenant);
...
SELECT 'Tabela users (v6) criada. Lembre-se de gerar o hash da senha do SUPER_ADMIN no backend.' as result;
